...
class sg_subscribe_settings {
	...
	function options_page() {
		...
		if ( isset($_POST['sg_subscribe_settings_submit']) )
			echo '<div class="single hentry subscription-manager-shadow"><p><strong>' . __('Options saved.', 'subscribe-to-comments') . '</strong></p></div>';
...
class sg_subscribe {
	...
	function show_messages($before_all='', $after_all='', $before_each='<div class="single hentry subscription-manager-shadow"><p>', $after_each='</p></div>'){
...
function sg_subscribe_admin($standalone = false) {
	...
	<div class="single hentry subscription-manager-shadow">
